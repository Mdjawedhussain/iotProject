...
const char *ssid =  "robertraj";     // Enter your WiFi Name
const char *pass =  "12345678"; // Enter your WiFi Password

#define MQTT_SERV "io.adafruit.com"
#define MQTT_PORT 1883
#define MQTT_NAME "raj0"
#define MQTT_PASS "aio_yeHW96BCKx84qZfUP8GvVCkMsPlN"
WiFiUDP ntpUDP;
...
void setup() {
  ...
  timeClient.begin(); 
  myservo.attach(D3);      // servo pin to D6
  myservos.attach(D4 );       // servo pin to D5
